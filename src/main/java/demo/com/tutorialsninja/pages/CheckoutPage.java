...
public class CheckoutPage extends Utility {
    ...
    public void clickOnGuestCheckoutRadioButton() {
        clickOnTheElement(guestCheckoutRadioButton);
    }
    ...
    public void clickOnContinueBillingButton() {
        clickOnTheElement(continueButtonBillingDetails);
    }

    public void clickOnContinueCommentButton() {
        clickOnTheElement(continueButtonCommentDetails);
    }
    ...
    public void enterBillingDetails() throws InterruptedException {
        ...
        sendTextToElement(email, "Patel" + getRandomEmail());
    ...
    public void clickOnAgreeToTermsAndConditions() {
        clickOnTheElement(termsAndConditionsRadioBox);
    }
